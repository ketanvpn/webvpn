...
interface TelegramVpnSectionProps {
  vpnTelegramId: number | null;
  vpnLink: string | null;
  vpnLinkLoading: boolean;
  vpnUnlinkLoading: boolean;
  onGetVpnLink: () => void;
  onUnlinkVpn: () => void;
  onResetVpnLink: () => void;
}

export function TelegramVpnSection({
  vpnTelegramId,
  vpnLink,
  vpnLinkLoading,
  vpnUnlinkLoading,
      ...
      <div className="px-5 py-4">
        ...
        {vpnTelegramId ? (
          <div className="rounded-lg bg-green-50 border border-green-200 px-3 py-2.5 flex items-center justify-between">
            <p className="text-xs text-green-700">ID: {vpnTelegramId}</p>
            <button
              onClick={onUnlinkVpn}
